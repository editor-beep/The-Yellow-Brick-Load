/**
 * YELLOW BRICK LOAD — Wicked Witch of the West Ending Passages
 * Character: Witch West (Authority Figure / Surveillance Operator)
 *
 * All isEnding: true passages.
 * Branch passages are in witch_west_stubs.js.
 */

export const witchWestEndingPassages = {
...
When the witch is rebuilt from the meat of her victims, who is truly being punished?`,
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // W-END-28: THE SEARING TRUTH
  // ─────────────────────────────────────────────────────────────────────────

  WITCH_WEST_END_SEARING_TRUTH: {
    id: 'WITCH_WEST_END_SEARING_TRUTH',
    character: 'witch_west',
    endingId: 'W-END-28',
    endingName: 'The Searing Truth',
    institution: 'Physics',
    systemStatus: 'Smoldering',
    isEnding: true,
    surreality: 10,
    text: [
      {
        minOverrender: 0,
        content: `THE FINAL LOG [W-END-28]
The audit has solved itself.
There is no more Lion. There is no more girl. The friction of your observation became so intense that the assets and the observer fused into a single, glowing point of high-density logic.
The tower didn't burn; it **sublimated**. The Winkies stopped chanting because there was no longer any air to carry the sound. The obsidian eye cracked, and through the fissure, you saw the Bureau's real face: a vast, unblinking server rack stretching into the Unlit Basement.
You aren't a witch anymore. You are a thermal signature. You are a successful calculation.
Final Log: Heat is the byproduct of solving the system. 1 - 1 = 1.
If the truth is bright enough to blind the eye that found it, was it ever meant to be seen?`,
      },
    ],
    choices: [],
    onEnter: [],
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // W-END-13: THE GHOST BIT
  // ─────────────────────────────────────────────────────────────────────────

  WITCH_WEST_END_GHOST_BIT: {
    id: 'WITCH_WEST_END_GHOST_BIT',
    character: 'witch_west',
    endingId: 'W-END-13',
    endingName: 'The Ghost Bit',
    ...
    text: [
      {
        minOverrender: 0,
        content: `THE FINAL LOG [W-END-13]
The surveillance is over. There is no one left to watch, and no eye to watch them with.
You have become a Ghost Bit—a piece of data that the Oz OS can no longer name. You are the silence between the logs. You are the gap between the yellow bricks. You are the part of the Witch that wasn't "Wicked," just **unaligned**.
The Clerk doesn't find you. The monkeys don't hear you. You sit in the dark, and for the first time since the audit began, the vibration stops.
Final Log: Truth exists only in the silence between the logs.
1 - 1 = 0.
If you are no longer indexed, do you still have a shadow, or are you finally the light?`,
      },
    ],
    choices: [],
    onEnter: [],
